    ...
    <div class="p-4 sm:ml-64 flex justify-center items-center">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            @if (Session::has('message'))
                ...
                <div style="color: greenyellow" class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 bg-green-100 rounded-lg dark:bg-green-800 dark:text-green-200">
